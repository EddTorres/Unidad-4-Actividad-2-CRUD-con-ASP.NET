<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="AgregarDocente.aspx.vb" Inherits="Unidad_4___Actividad_2___CRUD_con_ASP.NET.AgregarDocente" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table align="center" style="width: 60%; border: 2px solid #0066FF; background-color: #99CCFF">
        ...
        <tr>
            ...
            <td style="width: 33px">&nbsp;</td>
            <td style="width: 561px">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TxtCorreo" ErrorMessage="Ingrese correo de docente"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 561px; height: 24px;">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TxtTelefono" ErrorMessage="Ingrese telefono de docente"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
